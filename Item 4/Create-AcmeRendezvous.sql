...
INSERT INTO `administrator` VALUES (5,0,'1986-02-16','Admin@email.com','adminname','AdminphoneNumber','AdminpostalAdrdress','Adminsurname',4);
...
CREATE TABLE `config` (
  ...
  `welcomeEnglish` varchar(255) DEFAULT NULL,
  `welcomeSpanish` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `config` VALUES (6,0,'https://tinyurl.com/adventure-meetup','Adventure meetups','Your place to organise your adventure meetups!','Tu sitio para organizar quedadas de aventura');
...
CREATE TABLE `service` (
  ...
  PRIMARY KEY (`id`),
  KEY `UK_b4cm9vow7ammhwy6shllba39c` (`cancelled`),
...
INSERT INTO `useraccount_authorities` VALUES (4,'ADMINISTRATOR');
...
-- Dump completed on 2018-03-23 15:52:29
